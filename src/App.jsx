...
const App = () => {
  ...
  const teamMembers = {
    students: [
      { name: 'Dev "Gang-Rape" Gavande', role: 'Team Captain, Founder, Driver, CAD Lead, Build Team Lead', image: '/data/team/dev.jpg', initials: 'D', rookie: false },
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="border-t-2 border-gray-800 pt-8 text-center">
            ...
            <p className="text-gray-600 text-xs mt-2">
              Website developed by Sahejdeep Singh
            </p>
          </div>
        </div>
      </footer>
